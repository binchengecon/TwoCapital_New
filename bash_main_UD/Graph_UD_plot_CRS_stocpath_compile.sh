...
python_name_unit="Result_2jump_UD_plot_CRS_FK_infinity_newlabel_stocpath_compile.py"
server_name="mercury"
                ...
                for PSI_1 in ${psi1arr[@]}; do
                        for varrho in ${varrhoarr[@]}; do
                            for k in $(seq 0 $LENGTH_scheme); do
                                ...
                                mkdir -p ./job-outs/${action_name}/Graph_PlotArea/scheme_${scheme_array[$k]}_HJB_${HJBsolution_array[$k]}/xia_${xi_a[$j]}_xic_${xi_c[$j]}_xid_${xi_d[$j]}_xig_${xi_g[$j]}_PSI0_${PSI_0}_PSI1_${PSI_1}_varrho_${varrho}/
...
#SBATCH --output=./job-outs/${action_name}/Graph_PlotArea/scheme_${scheme_array[$k]}_HJB_${HJBsolution_array[$k]}/xia_${xi_a[$j]}_xic_${xi_c[$j]}_xid_${xi_d[$j]}_xig_${xi_g[$j]}_PSI0_${PSI_0}_PSI1_${PSI_1}_varrho_${varrho}/graph_${HJBsolution_array[$k]}_${python_name_unit}.out
#SBATCH --error=./job-outs/${action_name}/Graph_PlotArea/scheme_${scheme_array[$k]}_HJB_${HJBsolution_array[$k]}/xia_${xi_a[$j]}_xic_${xi_c[$j]}_xid_${xi_d[$j]}_xig_${xi_g[$j]}_PSI0_${PSI_0}_PSI1_${PSI_1}_varrho_${varrho}/graph_${HJBsolution_array[$k]}_${python_name_unit}.err
