...
python_name="postdamage_2jump_CRS2_delta_rho_treat1diff_new2_flow.py" # 3 dmg
...
for epsilon in ${epsilonarray[@]}; do
	for hXarri in "${hXarrays[@]}"; do
		...
		action_name="2jump_step_${Xminarr[0]},${Xmaxarr[0]}_${Xminarr[1]},${Xmaxarr[1]}_${Xminarr[2]},${Xmaxarr[2]}_${Xminarr[3]},${Xmaxarr[3]}_SS_${hXarr[0]},${hXarr[1]},${hXarr[2]}_LR_${epsilon}_FK_flow3over4_phi0_${phi0arr[$phi0index]}"
