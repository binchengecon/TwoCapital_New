...
python_name="postdamage_2jump_CRS2_delta_rho_treat1diff_new2_sub_flow.py" # 3 dmg
...
for epsilon in ${epsilonarray[@]}; do
	for hXarri in "${hXarrays[@]}"; do
		...
		action_name="2jump_step_${Xminarr[0]},${Xmaxarr[0]}_${Xminarr[1]},${Xmaxarr[1]}_${Xminarr[2]},${Xmaxarr[2]}_${Xminarr[3]},${Xmaxarr[3]}_SS_${hXarr[0]},${hXarr[1]},${hXarr[2]}_LR_${epsilon}_FK_flow_phi0_${phi0arr[$phi0index]}"
					...
					for varrho in ${varrhoarr[@]}; do
						for j in $(seq 0 $LENGTH_xi); do
							for k in $(seq 0 $LENGTH_rho); do
								...
								mkdir -p ./job-outs/${action_name}/Post_Sub2/xia_${xi_a[$j]}_xik_${xi_k[$j]}_xic_${xi_c[$j]}_xij_${xi_j[$j]}_xid_${xi_d[$j]}_xig_${xi_g[$j]}_PSI01_${PSI_01}_PSI02_${PSI_02}_PSI1_${PSI_1}_varrho_${varrho}_rho_${rhoarr[$k]}_delta_${deltaarr[$k]}/
...
#SBATCH --output=./job-outs/${action_name}/Post_Sub2/xia_${xi_a[$j]}_xik_${xi_k[$j]}_xic_${xi_c[$j]}_xij_${xi_j[$j]}_xid_${xi_d[$j]}_xig_${xi_g[$j]}_PSI01_${PSI_01}_PSI02_${PSI_02}_PSI1_${PSI_1}_varrho_${varrho}_rho_${rhoarr[$k]}_delta_${deltaarr[$k]}/mercury_post_${i}_sub2.out
#SBATCH --error=./job-outs/${action_name}/Post_Sub2/xia_${xi_a[$j]}_xik_${xi_k[$j]}_xic_${xi_c[$j]}_xij_${xi_j[$j]}_xid_${xi_d[$j]}_xig_${xi_g[$j]}_PSI01_${PSI_01}_PSI02_${PSI_02}_PSI1_${PSI_1}_varrho_${varrho}_rho_${rhoarr[$k]}_delta_${deltaarr[$k]}/mercury_post_${i}_sub2.err
