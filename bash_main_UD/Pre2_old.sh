...
# python_name="postdamage_2jump_CRS2_old.py"
python_name="predamage_2jump_CRS2_old.py"
...
######## login
#SBATCH --job-name=${hXarr[0]}_xia_${xi_a[$j]}_xik_${xi_k[$j]}_xic_${xi_c[$j]}_xij_${xi_j[$j]}_xid_${xi_d[$j]}_xig_${xi_g[$j]}_${PSI_0}_${PSI_1}_${varrho}_${epsilon}_${phi0arr[$phi0index]}
