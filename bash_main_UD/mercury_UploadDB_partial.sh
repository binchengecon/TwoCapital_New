...
action_name="UploadDB_Parallel_partial2"
python_name="UploadDB5.py"
MotherRoot="/scratch/bincheng/abatement/data_2tech/"
DaughterRoot="/climatesocialpolicy/data_simul6/"
...
python3 /home/bcheng4/TwoCapital_Shrink/abatement/$python_name --Folder ${Folder} --MotherRoot ${MotherRoot} --DaughterRoot ${DaughterRoot}  --access_token ${access_token} --refresh_token ${refresh_token} --partname ${partname}
