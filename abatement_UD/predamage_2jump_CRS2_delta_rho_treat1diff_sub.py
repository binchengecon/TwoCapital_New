...
from src.PostSolver2_old import hjb_post_damage_post_tech as hjb_post_damage_post_tech_rho1
from src.PostSolver2_old import hjb_pre_damage_post_tech as hjb_pre_damage_post_tech_rho1
from src.PreSolver_CRS2_old import hjb_pre_tech as hjb_pre_tech_rho1
import argparse
...
parser.add_argument("--rho_sub", type=float)
parser.add_argument("--delta_sub", type=float)
...
File_Name_sub = "xi_a_{}_xi_k_{}_xi_c_{}_xi_j_{}_xi_d_{}_xi_g_{}_psi_0_{}_psi_1_{}_varrho_{}_rho_{}_delta_{}_" .format(xi_a, xi_k, xi_c, xi_j, xi_d, xi_g, psi_0,psi_1, varrho, rho_sub, delta_sub)
...
Guess_sub = pickle.load(open(Data_Dir+ File_Name_sub + "model_tech2_pre_damage", "rb"))
...
if rho==1:
    ...
    model_tech2_pre_damage = hjb_pre_damage_post_tech_rho1(
            K, Y_short, 
            model_args=(delta, alpha, kappa, mu_k, sigma_k, theta_ell, pi_c_o, sigma_y, xi_a, xi_k, xi_c, xi_j, xi_d, xi_g, pi_d_o, v_i, gamma_1, gamma_2, theta, lambda_bar_second, vartheta_bar_second, y_bar_lower),
            v0=v, 
            smart_guess =Guess_sub,
    ...
    model_tech2_pre_damage = hjb_pre_damage_post_tech(
            K, Y_short, 
            model_args=(delta, alpha, kappa, mu_k, sigma_k, theta_ell, pi_c_o, sigma_y, xi_a, xi_k, xi_c, xi_j, xi_d, xi_g, rho, pi_d_o, v_i, gamma_1, gamma_2, theta, lambda_bar_second, vartheta_bar_second, y_bar_lower),
            v0=v, 
            smart_guess =Guess_sub,
            epsilon=epsilonarr[0], 
            fraction=fractionarr[0],
...
Guess_sub = pickle.load(open(Data_Dir+ File_Name_sub + "model_tech1_pre_damage", "rb"))
Guess = Guess_sub

if rho==1:
    model_args =(delta, alpha, theta, vartheta_bar, lambda_bar, mu_k, kappa, sigma_k, theta_ell, pi_c_o, pi_c, sigma_y, zeta, psi_0, psi_1, sigma_g, v_tech2, gamma_1, gamma_2, gamma_3_list, y_bar, xi_a, xi_k, xi_c, xi_j, xi_d, xi_g, varrho)
    ...
    model_args =(delta, alpha, theta, vartheta_bar, lambda_bar, mu_k, kappa, sigma_k, theta_ell, pi_c_o, pi_c, sigma_y, zeta, psi_0, psi_1, sigma_g, v_tech2, gamma_1, gamma_2, gamma_3_list, y_bar, xi_a, xi_k, xi_c, xi_j, xi_d, xi_g, rho, varrho)
