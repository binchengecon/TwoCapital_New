...
model_tech2_post_damage_sub = pickle.load(open(Data_Dir + File_Name_sub + "model_tech2_post_damage_gamma_{:.4f}".format(gamma_3_i), "rb"))


v_sub = model_tech2_post_damage_sub["v"]
...
if rho==1:
    ...
    model_tech2_post_damage = hjb_post_damage_post_tech_rho1(
            K, Y, model_args, v0=v_sub,
...
with open(Data_Dir+ File_Name_sub + "model_tech1_post_damage_gamma_{:.4f}".format(gamma_3_i), "rb") as f:
    Guess_sub = pickle.load(f)
