...
def model_simulation_generate(xi_a,xi_k,xi_c,xi_j,xi_d,xi_g,psi_0,psi_1,varrho,rho):
    ...
    with open(Data_Dir + File_Dir+"model_tech1_pre_damage"+"_FK_UD_simul_{}".format(IntPeriod)+ scheme + "_" +HJB_solution, "rb") as f:
        res = pickle.load(f)
    ...
    for id_psi0 in range(len(psi0arr)):
        for id_psi1 in range(len(psi1arr)):
            for id_varrho in range(len(varrhoarr)):
                ...
                plt.plot(res["years"][res["states"][:, 1]<1.5], np.log(res["svrd_orig"])[res["states"][:, 1]<1.5],label=labellist[id_xiag],linewidth=5.0)
...
plt.savefig(Plot_Dir+"/logSVRD_orig_"+Filename+"_rho={}_delta={}".format(rho,delta)+".pdf")
plt.savefig(Plot_Dir+"/logSVRD_orig_"+Filename+"_rho={}_delta={}".format(rho,delta)+".png")
plt.close()
    ...
    for id_psi0 in range(len(psi0arr)):
        for id_psi1 in range(len(psi1arr)):
            for id_varrho in range(len(varrhoarr)):
                ...
                plt.plot(res["years"][res["states"][:, 1]<1.5], np.log(res["svrd_orig"])[res["states"][:, 1]<1.5],label=labellist[id_xiag],linewidth=5.0, color = color_one)
                plt.plot(res["years"][res["states"][:, 1]<1.5], np.log(res["svrd_dis"])[res["states"][:, 1]<1.5],label=labellist[id_xiag],linewidth=5.0,linestyle="--", color = color_one)
...
plt.savefig(Plot_Dir+"/logSVRD_orig_dis_"+Filename+"_rho={}_delta={}".format(rho,delta)+".pdf")
plt.savefig(Plot_Dir+"/logSVRD_orig_dis_"+Filename+"_rho={}_delta={}".format(rho,delta)+".png")
plt.close()
    ...
    for id_psi0 in range(len(psi0arr)):
        for id_psi1 in range(len(psi1arr)):
            for id_varrho in range(len(varrhoarr)):
                ...
                plt.plot(res["years"][res["states"][:, 1]<1.5], np.log(res["svrd_orig"])[res["states"][:, 1]<1.5],label=labellist[id_xiag],linewidth=5.0, color = color_one)
                plt.plot(res["years"][res["states"][:, 1]<1.5], np.log(res["svrd_undis"])[res["states"][:, 1]<1.5],label=labellist[id_xiag],linewidth=5.0,linestyle="--", color = color_one)
...
plt.savefig(Plot_Dir+"/logSVRD_orig_undis_"+Filename+"_rho={}_delta={}".format(rho,delta)+".pdf")
plt.savefig(Plot_Dir+"/logSVRD_orig_undis_"+Filename+"_rho={}_delta={}".format(rho,delta)+".png")
plt.close()
