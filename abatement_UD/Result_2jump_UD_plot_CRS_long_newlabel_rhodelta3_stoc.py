...
def model_simulation_generate(xi_a,xi_k,xi_c,xi_j,xi_d,xi_g,psi_0,psi_1,varrho,rho):
    ...
    with open(Data_Dir + File_Dir+"model_tech1_pre_damage"+"_UD_simulstoccompile_{}".format(IntPeriod)+ scheme + "_" +HJB_solution, "rb") as f:
        res = pickle.load(f)
        ...
        for id_psi1 in range(len(psi1arr)):
            for id_varrho in range(len(varrhoarr)):
                ...
                if xiaarr[id_xiag]>10:
                    plt.plot(res["years"][res["states"][:, 1]<1.5], ((res["x"]/(alpha*np.exp(res["states"][:,0])))*100)[res["states"][:, 1]<1.5],linewidth=5.0)
                else:
                    plt.plot(res["years"][res["states"][:, 1]<1.5], ((res["x"]/(alpha*np.exp(res["states"][:,0])))*100)[res["states"][:, 1]<1.5],linewidth=5.0)
                plt.xlabel('Years')
                plt.ylabel('$\%$ of GDP')
    ...
    for id_psi0 in range(len(psi0arr)):
        for id_psi1 in range(len(psi1arr)):
            for id_varrho in range(len(varrhoarr)):
                ...
                if xiaarr[id_xiag]>10:
                    plt.plot(res["years"][res["states"][:, 1]<1.5], res["x"][res["states"][:, 1]<1.5],linewidth=5.0)
                else:
                    plt.plot(res["years"][res["states"][:, 1]<1.5], res["x"][res["states"][:, 1]<1.5],linewidth=5.0)
                plt.xlabel('Years')
                # plt.ylabel('')
    ...
    for id_psi0 in range(len(psi0arr)):
        for id_psi1 in range(len(psi1arr)):
            for id_varrho in range(len(varrhoarr)):
                ...
                if xiaarr[id_xiag]>10:
                    plt.plot(res["years"][res["states"][:, 1]<1.5], (((res["x"]/(alpha*np.exp(res["states"][:,0])))*100)*(1-res["true_tech_prob"]))[res["states"][:, 1]<1.5],linewidth=5.0)
                else:
                    plt.plot(res["years"][res["states"][:, 1]<1.5], (((res["x"]/(alpha*np.exp(res["states"][:,0])))*100)*(1-res["true_tech_prob"]))[res["states"][:, 1]<1.5],linewidth=5.0)
                plt.xlabel('Years')
                plt.ylabel('$\%$ of GDP')
        ...
        for id_psi1 in range(len(psi1arr)):
            for id_varrho in range(len(varrhoarr)):
                ...
                if xiaarr[id_xiag]>10:
                    ...
                    plt.plot(res["years"][res["states"][:, 1]<1.5], res["i"][res["states"][:, 1]<1.5],linewidth=5.0)
                else:
                    plt.plot(res["years"][res["states"][:, 1]<1.5], res["i"][res["states"][:, 1]<1.5],linewidth=5.0)
                plt.xlabel('Years')
        ...
        for id_psi1 in range(len(psi1arr)):
            for id_varrho in range(len(varrhoarr)):
                ...
                if xiaarr[id_xiag]>10:
                    ...
                    plt.plot(res["years"][res["states"][:, 1]<1.5], (res["i"]/(alpha*np.exp(res["states"][:,0]))*100)[res["states"][:, 1]<1.5],linewidth=5.0)
                else:
                    plt.plot(res["years"][res["states"][:, 1]<1.5], (res["i"]/(alpha*np.exp(res["states"][:,0]))*100)[res["states"][:, 1]<1.5],linewidth=5.0)
                plt.xlabel('Years')
    ...
    for id_psi0 in range(len(psi0arr)):
        for id_psi1 in range(len(psi1arr)):
            for id_varrho in range(len(varrhoarr)):
                ...
                if xiaarr[id_xiag]>10:
                    plt.plot(res["years"][res["states"][:, 1]<1.5], res["e"][res["states"][:, 1]<1.5],linewidth=5.0)
                else:
                    plt.plot(res["years"][res["states"][:, 1]<1.5], res["e"][res["states"][:, 1]<1.5],linewidth=5.0)
    ...
    for id_psi0 in range(len(psi0arr)):
        for id_psi1 in range(len(psi1arr)):
            for id_varrho in range(len(varrhoarr)):
                ...
                if xiaarr[id_xiag]>10:
                    plt.plot(res["years"][res["states"][:, 1]<1.5], ( res["e"] * (1-res["true_tech_prob"]) )[res["states"][:, 1]<1.5] ,linewidth=5.0)
                else:
                    plt.plot(res["years"][res["states"][:, 1]<1.5], ( res["e"] * (1-res["true_tech_prob"]) )[res["states"][:, 1]<1.5] ,linewidth=5.0)
                # plt.plot(res2["years"][res2["states"][:, 1]<1.5], res2["e"][res2["states"][:, 1]<1.5],label=r'$\xi_a=\\xi_g=0.050$',linewidth=7.0)
                # plt.plot(res3["years"][res3["states"][:, 1]<1.5], res3["e"][res3["states"][:, 1]<1.5],linewidth=7.0)
        ...
        for id_psi1 in range(len(psi1arr)):
            for id_varrho in range(len(varrhoarr)):
                ...
                if xiaarr[id_xiag]>10:
                    ...
                    plt.plot(res["years"][res["states"][:, 1]<1.5], res["states"][:, 1][res["states"][:, 1]<1.5],linewidth=5.0)
                else:
                    plt.plot(res["years"][res["states"][:, 1]<1.5], res["states"][:, 1][res["states"][:, 1]<1.5],linewidth=5.0)
        ...
        for id_psi1 in range(len(psi1arr)):
            for id_varrho in range(len(varrhoarr)):
                ...
                if xiaarr[id_xiag]>10:
                    ...
                    plt.plot(res["years"][res["states"][:, 1]<1.5], np.exp(res["states"][:, 2])[res["states"][:, 1]<1.5],linewidth=5.0)
                else:
                    plt.plot(res["years"][res["states"][:, 1]<1.5], np.exp(res["states"][:, 2])[res["states"][:, 1]<1.5],linewidth=5.0)
        ...
        for id_psi1 in range(len(psi1arr)):
            for id_varrho in range(len(varrhoarr)):
                ...
                if xiaarr[id_xiag]>10:
                    ...
                    plt.plot(res["years"], res["distorted_tech_prob"],linewidth=5.0)
                else:
                    plt.plot(res["years"], res["distorted_tech_prob"],linewidth=5.0)
        ...
        for id_psi1 in range(len(psi1arr)):
            for id_varrho in range(len(varrhoarr)):
                ...
                if xiaarr[id_xiag]>10:
                    ...
                    plt.plot(res["years"], res["distorted_damage_prob"],linewidth=5.0)
                else:
                    plt.plot(res["years"], res["distorted_damage_prob"],linewidth=5.0)
        ...
        for id_psi1 in range(len(psi1arr)):
            for id_varrho in range(len(varrhoarr)):
                ...
                if xiaarr[id_xiag]>10:
                    ...
                    plt.plot(res["years"], res["true_tech_prob"],linewidth=5.0,linestyle = 'dashed',color=color_one)
                else:
                    plt.plot(res["years"], res["true_tech_prob"],label=labellist[id_xiag] ,linewidth=5.0,linestyle = 'dashed',color=color_one)
                    
                if xiaarr[id_xiag]>10:

                    plt.plot(res["years"], res["distorted_tech_prob"],linewidth=5.0,color=color_one)
                else:
        ...
        for id_psi1 in range(len(psi1arr)):
            for id_varrho in range(len(varrhoarr)):
                ...
                if xiaarr[id_xiag]>10:
                    ...
                    plt.plot(res["years"], res["true_damage_prob"],linewidth=5.0,linestyle = 'dashed',color=color_one)
                else:
                    plt.plot(res["years"], res["true_damage_prob"],label=labellist[id_xiag] ,linewidth=5.0,linestyle = 'dashed',color=color_one)
                    
                if xiaarr[id_xiag]>10:

                    plt.plot(res["years"], res["distorted_damage_prob"],linewidth=5.0,color=color_one)
                else:
        ...
        for id_psi1 in range(len(psi1arr)):
            for id_varrho in range(len(varrhoarr)):
                ...
                if xiaarr[id_xiag]>10:
                    ...
                    plt.plot(res["years"], res["true_tech_prob"],linewidth=5.0)
                else:
                    plt.plot(res["years"], res["true_tech_prob"],linewidth=5.0)
        ...
        for id_psi1 in range(len(psi1arr)):
            for id_varrho in range(len(varrhoarr)):
                ...
                if xiaarr[id_xiag]>10:
                    ...
                    plt.plot(res["years"], res["true_damage_prob"],linewidth=5.0)
                else:
                    plt.plot(res["years"], res["true_damage_prob"],linewidth=5.0)
        ...
        for id_psi1 in range(len(psi1arr)):
            for id_varrho in range(len(varrhoarr)):
                ...
                if xiaarr[id_xiag]>10:
                    ...
                    plt.plot(res["years"][res["states"][:, 1]<1.5], np.log(res["scc"])[res["states"][:, 1]<1.5],linewidth=5.0)
                else:
                    plt.plot(res["years"][res["states"][:, 1]<1.5], np.log(res["scc"])[res["states"][:, 1]<1.5],linewidth=5.0)
        ...
        for id_psi1 in range(len(psi1arr)):
            for id_varrho in range(len(varrhoarr)):
                ...
                if xiaarr[id_xiag]>10:
                    ...
                    plt.plot(res["years"][res["states"][:, 1]<1.5], np.log(res["scrd"])[res["states"][:, 1]<1.5],linewidth=5.0)
                else:
                    plt.plot(res["years"][res["states"][:, 1]<1.5], np.log(res["scrd"])[res["states"][:, 1]<1.5],linewidth=5.0)
        ...
        for id_psi1 in range(len(psi1arr)):
            for id_varrho in range(len(varrhoarr)):
                ...
                if xiaarr[id_xiag]>10:
                    ...
                    plt.plot(res["years"][res["states"][:, 1]<1.5], np.log(res["scgw"])[res["states"][:, 1]<1.5],linewidth=5.0)
                else:
                    plt.plot(res["years"][res["states"][:, 1]<1.5], np.log(res["scgw"])[res["states"][:, 1]<1.5],linewidth=5.0)
        ...
        for id_psi1 in range(len(psi1arr)):
            for id_varrho in range(len(varrhoarr)):
                ...
                if xiaarr[id_xiag]>10:
                    ...
                    plt.plot(res["years"][res["states"][:, 1]<1.5], np.log(res["scrd_2"])[res["states"][:, 1]<1.5],linewidth=5.0)
                else:
                    plt.plot(res["years"][res["states"][:, 1]<1.5], np.log(res["scrd_2"])[res["states"][:, 1]<1.5],linewidth=5.0)
        ...
        for id_psi1 in range(len(psi1arr)):
            for id_varrho in range(len(varrhoarr)):
                ...
                if xiaarr[id_xiag]>10:
                    ...
                    plt.plot(res["years"][res["states"][:, 1]<1.5], np.log(res["spo"])[res["states"][:, 1]<1.5],linewidth=5.0)
                else:
                    plt.plot(res["years"][res["states"][:, 1]<1.5], np.log(res["spo"])[res["states"][:, 1]<1.5],linewidth=5.0)
        ...
        for id_psi1 in range(len(psi1arr)):
            for id_varrho in range(len(varrhoarr)):
                ...
                if xiaarr[id_xiag]>10:
                    ...
                    plt.plot(res["years"][res["states"][:, 1]<1.5], np.log(res["spo2"])[res["states"][:, 1]<1.5],linewidth=5.0)
                else:
                    plt.plot(res["years"][res["states"][:, 1]<1.5], np.log(res["spo2"])[res["states"][:, 1]<1.5],linewidth=5.0)
        ...
        for id_psi1 in range(len(psi1arr)):
            for id_varrho in range(len(varrhoarr)):
                ...
                if xiaarr[id_xiag]>10:
                    ...
                    plt.plot(res["years"][res["states"][:, 1]<1.5], res["uncertainty_adjusted_diff"][res["states"][:, 1]<1.5],linewidth=5.0)
                else:
                    plt.plot(res["years"][res["states"][:, 1]<1.5], res["uncertainty_adjusted_diff"][res["states"][:, 1]<1.5],linewidth=5.0)
        ...
        for id_psi1 in range(len(psi1arr)):
            for id_varrho in range(len(varrhoarr)):
                ...
                if xiaarr[id_xiag]>10:
                    ...
                    plt.plot(res["years"][res["states"][:, 1]<1.5], res["uncertainty_adjusted_diff2"][res["states"][:, 1]<1.5],linewidth=1.0)
                else:
                    plt.plot(res["years"][res["states"][:, 1]<1.5], res["uncertainty_adjusted_diff2"][res["states"][:, 1]<1.5],linewidth=1.0)
        ...
        for id_psi1 in range(len(psi1arr)):
            for id_varrho in range(len(varrhoarr)):
                ...
                if xiaarr[id_xiag]>10:
                    ...
                    plt.plot(res["years"][res["states"][:, 1]<1.5], res["v_post_techt"][res["states"][:, 1]<1.5],linewidth=5.0)
                else:
                    plt.plot(res["years"][res["states"][:, 1]<1.5],res["v_post_techt"][res["states"][:, 1]<1.5],linewidth=5.0)
        ...
        for id_psi1 in range(len(psi1arr)):
            for id_varrho in range(len(varrhoarr)):
                ...
                if xiaarr[id_xiag]>10:
                    ...
                    plt.plot(res["years"][res["states"][:, 1]<1.5], res["vt"][res["states"][:, 1]<1.5],linewidth=5.0)
                else:
                    plt.plot(res["years"][res["states"][:, 1]<1.5], res["vt"][res["states"][:, 1]<1.5],linewidth=5.0)
        ...
        for id_psi1 in range(len(psi1arr)):
            for id_varrho in range(len(varrhoarr)):
                ...
                if xiaarr[id_xiag]>10:
                    ...
                    plt.plot(res["years"][res["states"][:, 1]<1.5], (res["v_post_techt"]-res["vt"])[res["states"][:, 1]<1.5],linewidth=5.0)
                else:
                    plt.plot(res["years"][res["states"][:, 1]<1.5], (res["v_post_techt"]-res["vt"])[res["states"][:, 1]<1.5],linewidth=5.0)
        ...
        for id_psi1 in range(len(psi1arr)):
            for id_varrho in range(len(varrhoarr)):
                ...
                if xiaarr[id_xiag]>10:
                    ...
                    plt.plot(res["years"][res["states"][:, 1]<1.5], (res["gt_tech"])[res["states"][:, 1]<1.5],linewidth=5.0)
                else:
                    plt.plot(res["years"][res["states"][:, 1]<1.5], (res["gt_tech"])[res["states"][:, 1]<1.5],linewidth=5.0)
...
#                 plt.savefig(Plot_Dir+"/Gamma3,xia={:.5f},xic={:.3f},xid={:.3f},xig={:.3f},psi0={:.3f},psi1={:.3f},varrho={:.1f}_rho={}_delta={}.png".format(xiaarr[id_xiag],xikarr[id_xiag],xicarr[id_xiag],xijarr[id_xiag],xidarr[id_xiag],xigarr[id_xiag],psi0arr[id_psi0],psi1arr[id_psi1], varrhoarr[id_varrho],rho,delta))
#                 plt.close()
...
#                 plt.ylim(0, 1.4)
#                 # plt.xlabel("Climate Sensitivity")
#                 plt.savefig(Plot_Dir+"/ClimateSensitivity_pmean_{},xia={:.4f},xic={:.3f},xid={:.3f},xig={:.3f},psi0={:.3f},psi1={:.3f},varrho={:.1f}_rho={}_delta={}.pdf".format(IntPeriod, xiaarr[id_xiag],xicarr[id_xiag], xidarr[id_xiag], xigarr[id_xiag],psi0arr[id_psi0],psi1arr[id_psi1], varrhoarr[id_varrho],rho,delta))
#                 plt.savefig(Plot_Dir+"/ClimateSensitivity_pmean_{},xia={:.4f},xic={:.3f},xid={:.3f},xig={:.3f},psi0={:.3f},psi1={:.3f},varrho={:.1f}_rho={}_delta={}.png".format(IntPeriod, xiaarr[id_xiag],xicarr[id_xiag], xidarr[id_xiag], xigarr[id_xiag],psi0arr[id_psi0],psi1arr[id_psi1], varrhoarr[id_varrho],rho,delta))
#                 plt.close()
