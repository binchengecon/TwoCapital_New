...
def model_simulation_generate(xi_a,xi_k,xi_c,xi_j,xi_d,xi_g,psi_0,psi_1,varrho,rho,gamma_3_i):
    ...
    with open(Data_Dir + File_Dir+"model_tech1_pre_damage_to_post_damage_{:.4f}".format(gamma_3_i)+"_UD_simul_{}".format(IntPeriod)+ scheme + "_" +HJB_solution, "rb") as f:
        res = pickle.load(f)
...
def model_simulation_generate2(xi_a,xi_k,xi_c,xi_j,xi_d,xi_g,psi_0,psi_1,varrho,rho):
...
for id_xiag in range(len(xiaarr)): 
    for id_psi0 in range(len(psi0arr)):
        for id_psi1 in range(len(psi1arr)):
            for id_varrho in range(len(varrhoarr)):
                for id_damage in range(num_gamma):


                    res = model_simulation_generate(xiaarr[id_xiag],xikarr[id_xiag],xicarr[id_xiag],xijarr[id_xiag],xidarr[id_xiag],xigarr[id_xiag],psi0arr[id_psi0],psi1arr[id_psi1], varrhoarr[id_varrho],rho,gamma_3_list[id_damage])

                    if xiaarr[id_xiag]>10:
                        plt.plot(res["years"], ((res["x"]/(alpha*np.exp(res["states"][:,0])))*100),label="$\lambda_3={:.4f}$".format(gamma_3_list[id_damage]),linewidth=5.0)
                    else:
                        plt.plot(res["years"], ((res["x"]/(alpha*np.exp(res["states"][:,0])))*100),label="$\lambda_3={:.4f}$".format(gamma_3_list[id_damage]),linewidth=5.0)
                    plt.xlabel('Years')
                    plt.ylabel('$\%$ of GDP')
    ...
    plt.savefig(Plot_Dir+"/RDPost3_2"+labellist[id_xiag]+Filename+"_rho={}_delta={}_phi0={}".format(rho,delta,phi_0)+".png")
    plt.close()
...
#                     res = model_simulation_generate(xiaarr[id_xiag],xikarr[id_xiag],xicarr[id_xiag],xijarr[id_xiag],xidarr[id_xiag],xigarr[id_xiag],psi0arr[id_psi0],psi1arr[id_psi1], varrhoarr[id_varrho],rho,gamma_3_list[id_damage])
#                     res2 = model_simulation_generate2(xiaarr[id_xiag],xikarr[id_xiag],xicarr[id_xiag],xijarr[id_xiag],xidarr[id_xiag],xigarr[id_xiag],psi0arr[id_psi0],psi1arr[id_psi1], varrhoarr[id_varrho],rho)

#                     if xiaarr[id_xiag]>10:
#                         plt.plot(res["years"][res["states"][:, 1]>1.5], ((res["x"]/(alpha*np.exp(res["states"][:,0])))*100)[res["states"][:, 1]>1.5],label="$\lambda_3={:.4f}$".format(gamma_3_list[id_damage]),linewidth=5.0)
#                     else:
#                         plt.plot(res["years"][res["states"][:, 1]>1.5], ((res["x"]/(alpha*np.exp(res["states"][:,0])))*100)[res["states"][:, 1]>1.5],label="$\lambda_3={:.4f}$".format(gamma_3_list[id_damage]),linewidth=5.0)
...
#                     if xiaarr[id_xiag]>10:
#                         plt.plot(res2["years"][res2["states"][:, 1]<1.5], ((res2["x"]/(alpha*np.exp(res["states"][:,0])))*100)[res2["states"][:, 1]<1.5], linewidth=5.0)
#                     else:
#                         plt.plot(res2["years"][res2["states"][:, 1]<1.5], ((res2["x"]/(alpha*np.exp(res["states"][:,0])))*100)[res2["states"][:, 1]<1.5], linewidth=5.0)
...
#     print(res.keys())
#     # plt.savefig(Plot_Dir+"/RD_"+Filename+"_rho={}_delta={}_phi0={}".format(rho,delta,phi_0)+".pdf")
#     plt.savefig(Plot_Dir+"/RDPost2_"+labellist[id_xiag]+Filename+"_rho={}_delta={}_phi0={}".format(rho,delta,phi_0)+".png")
#     plt.close()
...
#                 if xiaarr[id_xiag]>10:
#                     plt.plot(res["years"], res["x"],label="$\lambda_3={:.4f}$".format(gamma_3_list[id_damage]),linewidth=5.0)
#                 else:
#                     plt.plot(res["years"], res["x"],label="$\lambda_3={:.4f}$".format(gamma_3_list[id_damage]),linewidth=5.0)
#                 plt.xlabel('Years')
#                 # plt.ylabel('')
...
#                 if xiaarr[id_xiag]>10:
#                     plt.plot(res["years"], (((res["x"]/(alpha*np.exp(res["states"][:,0])))*100)*(1-res["true_tech_prob"])),label="$\lambda_3={:.4f}$".format(gamma_3_list[id_damage]),linewidth=5.0)
#                 else:
#                     plt.plot(res["years"], (((res["x"]/(alpha*np.exp(res["states"][:,0])))*100)*(1-res["true_tech_prob"])),label="$\lambda_3={:.4f}$".format(gamma_3_list[id_damage]),linewidth=5.0)
#                 plt.xlabel('Years')
#                 plt.ylabel('$\%$ of GDP')
...
# plt.savefig(Plot_Dir+"/RD_ExpectedPost_"+labellist[id_xiag]+Filename+"_rho={}_delta={}_phi0={}".format(rho,delta,phi_0)+".png")
# plt.close()
...
#                         plt.plot(res["years"], res["i"],label="$\lambda_3={:.4f}$".format(gamma_3_list[id_damage]),linewidth=5.0)
#                     else:
#                         plt.plot(res["years"], res["i"],label="$\lambda_3={:.4f}$".format(gamma_3_list[id_damage]),linewidth=5.0)
#                     plt.xlabel('Years')
...
#     plt.savefig(Plot_Dir+"/CapIPost_"+labellist[id_xiag]+Filename+"_rho={}_delta={}_phi0={}".format(rho,delta,phi_0)+".png")
#     plt.close()
...
#                     plt.plot(res["years"], (res["i"]/(alpha*np.exp(res["states"][:,0]))*100),label="$\lambda_3={:.4f}$".format(gamma_3_list[id_damage]),linewidth=5.0)
#                 else:
#                     plt.plot(res["years"], (res["i"]/(alpha*np.exp(res["states"][:,0]))*100),label="$\lambda_3={:.4f}$".format(gamma_3_list[id_damage]),linewidth=5.0)
#                 plt.xlabel('Years')
...
# # plt.savefig(Plot_Dir+"/CapI_"+Filename+"_rho={}_delta={}_phi0={}".format(rho,delta,phi_0)+".pdf")
# plt.savefig(Plot_Dir+"/CapIRatioPost_"+labellist[id_xiag]+Filename+"_rho={}_delta={}_phi0={}".format(rho,delta,phi_0)+".png")
# plt.close()
...
for id_xiag in range(len(xiaarr)): 
        ...
        for id_psi1 in range(len(psi1arr)):
            for id_varrho in range(len(varrhoarr)):
                for id_damage in range(num_gamma):
                    ...
                    if xiaarr[id_xiag]>10:
                        plt.plot(res["years"], res["e"],label="$\lambda_3={:.4f}$".format(gamma_3_list[id_damage]),linewidth=5.0)
                    else:
                        plt.plot(res["years"], res["e"],label="$\lambda_3={:.4f}$".format(gamma_3_list[id_damage]),linewidth=5.0)
                    # plt.plot(res2["years"][res2["states"][:, 1]<1.5], res2["e"][res2["states"][:, 1]<1.5],label=r'$\xi_a=\\xi_g=0.050$',linewidth=7.0)
                    # plt.plot(res3["years"][res3["states"][:, 1]<1.5], res3["e"][res3["states"][:, 1]<1.5],label="$\lambda_3={:.4f}$".format(gamma_3_list[id_damage]),linewidth=7.0)
                    plt.xlabel('Years')
    ...
    plt.savefig(Plot_Dir+"/EPost3_2"+labellist[id_xiag]+Filename+"_rho={}_delta={}_phi0={}".format(rho,delta,phi_0)+".png")
    plt.close()
...
#                     if xiaarr[id_xiag]>10:
#                         plt.plot(res["years"][res["states"][:, 1]>1.5], res["e"][res["states"][:, 1]>1.5],label="$\lambda_3={:.4f}$".format(gamma_3_list[id_damage]),linewidth=5.0)
#                     else:
#                         plt.plot(res["years"][res["states"][:, 1]>1.5], res["e"][res["states"][:, 1]>1.5],label="$\lambda_3={:.4f}$".format(gamma_3_list[id_damage]),linewidth=5.0)
                        
#                     if xiaarr[id_xiag]>10:
#                         plt.plot(res2["years"][res2["states"][:, 1]<1.5], res2["e"][res2["states"][:, 1]<1.5],linewidth=5.0)
#                     else:
#                         plt.plot(res2["years"][res2["states"][:, 1]<1.5], res2["e"][res2["states"][:, 1]<1.5],linewidth=5.0)
...
#     # plt.savefig(Plot_Dir+"/E_"+Filename+"_rho={}_delta={}_phi0={}".format(rho,delta,phi_0)+".pdf")
#     plt.savefig(Plot_Dir+"/EPost2_"+labellist[id_xiag]+Filename+"_rho={}_delta={}_phi0={}".format(rho,delta,phi_0)+".png")
#     plt.close()
# for id_xiag in range(len(xiaarr)): 
#     for id_psi0 in range(len(psi0arr)):
#         for id_psi1 in range(len(psi1arr)):
...
#                 if xiaarr[id_xiag]>10:
#                     plt.plot(res["years"], ( res["e"] * (1-res["true_tech_prob"]) ) ,label="$\lambda_3={:.4f}$".format(gamma_3_list[id_damage]),linewidth=5.0)
#                 else:
#                     plt.plot(res["years"], ( res["e"] * (1-res["true_tech_prob"]) ) ,label="$\lambda_3={:.4f}$".format(gamma_3_list[id_damage]),linewidth=5.0)
#                 # plt.plot(res2["years"][res2["states"][:, 1]<1.5], res2["e"][res2["states"][:, 1]<1.5],label=r'$\xi_a=\\xi_g=0.050$',linewidth=7.0)
#                 # plt.plot(res3["years"][res3["states"][:, 1]<1.5], res3["e"][res3["states"][:, 1]<1.5],label="$\lambda_3={:.4f}$".format(gamma_3_list[id_damage]),linewidth=7.0)
...
# plt.savefig(Plot_Dir+"/ETrue_ExpectedPost_"+labellist[id_xiag]+Filename+"_rho={}_delta={}_phi0={}".format(rho,delta,phi_0)+".png")
# plt.close()
...
for id_xiag in range(len(xiaarr)): 
            ...
            for id_varrho in range(len(varrhoarr)):
                for id_damage in range(num_gamma):
                    ...
                    if xiaarr[id_xiag]>10:
                        ...
                        plt.plot(res["years"], res["states"][:, 1],label="$\lambda_3={:.4f}$".format(gamma_3_list[id_damage]),linewidth=5.0)
                    else:
                        plt.plot(res["years"], res["states"][:, 1],label="$\lambda_3={:.4f}$".format(gamma_3_list[id_damage]),linewidth=5.0)
                    # plt.plot(res2["years"][res2["states"][:, 1]<1.5], res2["states"][:, 1][res2["states"][:, 1]<1.5],label=r'$\xi_a=\\xi_g=0.050$',linewidth=7.0)
                    # plt.plot(res3["years"][res3["states"][:, 1]<1.5], res3["states"][:, 1][res3["states"][:, 1]<1.5],label="$\lambda_3={:.4f}$".format(gamma_3_list[id_damage]),linewidth=7.0)
                    plt.xlabel('Years')
    ...
    plt.savefig(Plot_Dir+"/TAPost3_2"+labellist[id_xiag]+Filename+"_rho={}_delta={}_phi0={}".format(rho,delta,phi_0)+".png")
    plt.close()
...
#                         plt.plot(res["years"][res["states"][:, 1]>1.5], res["states"][:, 1][res["states"][:, 1]>1.5],label="$\lambda_3={:.4f}$".format(gamma_3_list[id_damage]),linewidth=5.0)
#                     else:
#                         plt.plot(res["years"][res["states"][:, 1]>1.5], res["states"][:, 1][res["states"][:, 1]>1.5],label="$\lambda_3={:.4f}$".format(gamma_3_list[id_damage]),linewidth=5.0)
                        
#                     if xiaarr[id_xiag]>10:

#                         plt.plot(res2["years"][res2["states"][:, 1]<1.5], res2["states"][:, 1][res2["states"][:, 1]<1.5],linewidth=5.0)
#                     else:
#                         plt.plot(res2["years"][res2["states"][:, 1]<1.5], res2["states"][:, 1][res2["states"][:, 1]<1.5],linewidth=5.0)
...
#     # plt.savefig(Plot_Dir+"/TA_"+Filename+"_rho={}_delta={}_phi0={}".format(rho,delta,phi_0)+".pdf")
#     plt.savefig(Plot_Dir+"/TAPost2_"+labellist[id_xiag]+Filename+"_rho={}_delta={}_phi0={}".format(rho,delta,phi_0)+".png")
#     plt.close()
# for id_xiag in range(len(xiaarr)): 
#     for id_psi0 in range(len(psi0arr)):
#         for id_psi1 in range(len(psi1arr)):
...
#                     plt.plot(res["years"], np.exp(res["states"][:, 2]),label="$\lambda_3={:.4f}$".format(gamma_3_list[id_damage]),linewidth=5.0)
#                 else:
#                     plt.plot(res["years"], np.exp(res["states"][:, 2]),label="$\lambda_3={:.4f}$".format(gamma_3_list[id_damage]),linewidth=5.0)
#                 # plt.plot(res2["years"][res2["states"][:, 1]<1.5], np.exp(res2["states"][:, 2])[res2["states"][:, 1]<1.5],label=r'$\xi_a=\\xi_g=0.050$',linewidth=7.0)
#                 # plt.plot(res3["years"][res3["states"][:, 1]<1.5], np.exp(res3["states"][:, 2])[res3["states"][:, 1]<1.5],label="$\lambda_3={:.4f}$".format(gamma_3_list[id_damage]),linewidth=7.0)
#                 plt.xlabel('Years')
...
# plt.savefig(Plot_Dir+"/IgPost_"+labellist[id_xiag]+Filename+"_rho={}_delta={}_phi0={}".format(rho,delta,phi_0)+".png")
# plt.close()
...
#                     plt.plot(res["years"], res["distorted_tech_prob"],label="$\lambda_3={:.4f}$".format(gamma_3_list[id_damage]),linewidth=5.0)
#                 else:
#                     plt.plot(res["years"], res["distorted_tech_prob"],label="$\lambda_3={:.4f}$".format(gamma_3_list[id_damage]),linewidth=5.0)
#                 # plt.plot(res2["years"], res2["distorted_tech_prob"],label=r'$\xi_a=\\xi_g=0.050$',linewidth=7.0)
#                 # plt.plot(res3["years"], res3["distorted_tech_prob"],label="$\lambda_3={:.4f}$".format(gamma_3_list[id_damage]),linewidth=7.0)
#                 plt.xlabel('Years')
...
# plt.savefig(Plot_Dir+"/ProbTechJumpPost_"+labellist[id_xiag]+Filename+"_rho={}_delta={}_phi0={}".format(rho,delta,phi_0)+".png")
# plt.close()
...
#                     plt.plot(res["years"], res["distorted_damage_prob"],label="$\lambda_3={:.4f}$".format(gamma_3_list[id_damage]),linewidth=5.0)
#                 else:
#                     plt.plot(res["years"], res["distorted_damage_prob"],label="$\lambda_3={:.4f}$".format(gamma_3_list[id_damage]),linewidth=5.0)
#                 # plt.plot(res2["years"], res2["distorted_damage_prob"],label=r'$\xi_a=\\xi_g=0.050$',linewidth=7.0)
#                 # plt.plot(res3["years"], res3["distorted_damage_prob"],label="$\lambda_3={:.4f}$".format(gamma_3_list[id_damage]),linewidth=7.0)
#                 plt.xlabel('Years')
...
# plt.savefig(Plot_Dir+"/ProbDamageChangePost_"+labellist[id_xiag]+Filename+"_rho={}_delta={}_phi0={}".format(rho,delta,phi_0)+".png")
# plt.close()
...
#                     plt.plot(res["years"], res["true_tech_prob"],label="$\lambda_3={:.4f}$".format(gamma_3_list[id_damage]),linewidth=5.0,linestyle = 'dashed',color=color_one)
#                 else:
#                     plt.plot(res["years"], res["true_tech_prob"],label="$\lambda_3={:.4f}$".format(gamma_3_list[id_damage]) ,linewidth=5.0,linestyle = 'dashed',color=color_one)
                    
#                 if xiaarr[id_xiag]>10:

#                     plt.plot(res["years"], res["distorted_tech_prob"],label="$\lambda_3={:.4f}$".format(gamma_3_list[id_damage]),linewidth=5.0,color=color_one)
#                 else:
#                     plt.plot(res["years"], res["distorted_tech_prob"],label="$\lambda_3={:.4f}$".format(gamma_3_list[id_damage]) ,linewidth=5.0,color=color_one)
#                 # plt.plot(res2["years"], res2["distorted_tech_prob"],label=r'$\xi_a=\\xi_g=0.050$',linewidth=7.0)
#                 # plt.plot(res3["years"], res3["distorted_tech_prob"],label="$\lambda_3={:.4f}$".format(gamma_3_list[id_damage]),linewidth=7.0)
...
# plt.savefig(Plot_Dir+"/CombProbTechJumpPost_"+labellist[id_xiag]+Filename+"_rho={}_delta={}_phi0={}".format(rho,delta,phi_0)+".png")
# plt.close()
...
#                     plt.plot(res["years"], res["true_damage_prob"],label="$\lambda_3={:.4f}$".format(gamma_3_list[id_damage]),linewidth=5.0,linestyle = 'dashed',color=color_one)
#                 else:
#                     plt.plot(res["years"], res["true_damage_prob"],label="$\lambda_3={:.4f}$".format(gamma_3_list[id_damage]) ,linewidth=5.0,linestyle = 'dashed',color=color_one)
                    
#                 if xiaarr[id_xiag]>10:

#                     plt.plot(res["years"], res["distorted_damage_prob"],label="$\lambda_3={:.4f}$".format(gamma_3_list[id_damage]),linewidth=5.0,color=color_one)
#                 else:
#                     plt.plot(res["years"], res["distorted_damage_prob"],label="$\lambda_3={:.4f}$".format(gamma_3_list[id_damage]) ,linewidth=5.0,color=color_one)
#                 # plt.plot(res2["years"], res2["distorted_tech_prob"],label=r'$\xi_a=\\xi_g=0.050$',linewidth=7.0)
#                 # plt.plot(res3["years"], res3["distorted_tech_prob"],label="$\lambda_3={:.4f}$".format(gamma_3_list[id_damage]),linewidth=7.0)
...
# plt.savefig(Plot_Dir+"/CombProbDamageChangePost_"+labellist[id_xiag]+Filename+"_rho={}_delta={}_phi0={}".format(rho,delta,phi_0)+".png")
# plt.close()
...
#                     plt.plot(res["years"], res["true_tech_prob"],label="$\lambda_3={:.4f}$".format(gamma_3_list[id_damage]),linewidth=5.0)
#                 else:
#                     plt.plot(res["years"], res["true_tech_prob"],label="$\lambda_3={:.4f}$".format(gamma_3_list[id_damage]),linewidth=5.0)
...
# plt.savefig(Plot_Dir+"/TPIgPost_"+labellist[id_xiag]+Filename+"_rho={}_delta={}_phi0={}".format(rho,delta,phi_0)+".png")
# plt.close()
...
#                     plt.plot(res["years"], res["true_damage_prob"],label="$\lambda_3={:.4f}$".format(gamma_3_list[id_damage]),linewidth=5.0)
#                 else:
#                     plt.plot(res["years"], res["true_damage_prob"],label="$\lambda_3={:.4f}$".format(gamma_3_list[id_damage]),linewidth=5.0)
...
# plt.savefig(Plot_Dir+"/TPIdPost_"+labellist[id_xiag]+Filename+"_rho={}_delta={}_phi0={}".format(rho,delta,phi_0)+".png")
# plt.close()
...
#                     plt.plot(res["years"], np.log(res["scc"]),label="$\lambda_3={:.4f}$".format(gamma_3_list[id_damage]),linewidth=5.0)
#                 else:
#                     plt.plot(res["years"], np.log(res["scc"]),label="$\lambda_3={:.4f}$".format(gamma_3_list[id_damage]),linewidth=5.0)
...
# plt.savefig(Plot_Dir+"/logSCCPost_"+labellist[id_xiag]+Filename+"_rho={}_delta={}_phi0={}".format(rho,delta,phi_0)+".png")
# plt.close()
...
#                     plt.plot(res["years"], np.log(res["scrd"]),label="$\lambda_3={:.4f}$".format(gamma_3_list[id_damage]),linewidth=5.0)
#                 else:
#                     plt.plot(res["years"], np.log(res["scrd"]),label="$\lambda_3={:.4f}$".format(gamma_3_list[id_damage]),linewidth=5.0)
...
# plt.savefig(Plot_Dir+"/logSVRDPost_"+labellist[id_xiag]+Filename+"_rho={}_delta={}_phi0={}".format(rho,delta,phi_0)+".png")
# plt.close()
...
#                     plt.plot(res["years"], np.log(res["scgw"]),label="$\lambda_3={:.4f}$".format(gamma_3_list[id_damage]),linewidth=5.0)
#                 else:
#                     plt.plot(res["years"], np.log(res["scgw"]),label="$\lambda_3={:.4f}$".format(gamma_3_list[id_damage]),linewidth=5.0)
...
# plt.savefig(Plot_Dir+"/logSCGWPost_"+labellist[id_xiag]+Filename+"_rho={}_delta={}_phi0={}".format(rho,delta,phi_0)+".png")
# plt.close()
...
#                     plt.plot(res["years"], np.log(res["scrd_2"]),label="$\lambda_3={:.4f}$".format(gamma_3_list[id_damage]),linewidth=5.0)
#                 else:
#                     plt.plot(res["years"], np.log(res["scrd_2"]),label="$\lambda_3={:.4f}$".format(gamma_3_list[id_damage]),linewidth=5.0)
...
# plt.savefig(Plot_Dir+"/logSVRD2Post_"+labellist[id_xiag]+Filename+"_rho={}_delta={}_phi0={}".format(rho,delta,phi_0)+".png")
# plt.close()
...
#                     plt.plot(res["years"], np.log(res["spo"]),label="$\lambda_3={:.4f}$".format(gamma_3_list[id_damage]),linewidth=5.0)
#                 else:
#                     plt.plot(res["years"], np.log(res["spo"]),label="$\lambda_3={:.4f}$".format(gamma_3_list[id_damage]),linewidth=5.0)
...
# plt.savefig(Plot_Dir+"/spoPost_"+labellist[id_xiag]+Filename+"_rho={}_delta={}_phi0={}".format(rho,delta,phi_0)+".png")
# plt.close()
...
#                     plt.plot(res["years"], np.log(res["spo2"]),label="$\lambda_3={:.4f}$".format(gamma_3_list[id_damage]),linewidth=5.0)
#                 else:
#                     plt.plot(res["years"], np.log(res["spo2"]),label="$\lambda_3={:.4f}$".format(gamma_3_list[id_damage]),linewidth=5.0)
...
# plt.savefig(Plot_Dir+"/spo2Post_"+labellist[id_xiag]+Filename+"_rho={}_delta={}_phi0={}".format(rho,delta,phi_0)+".png")
# plt.close()
...
#                     plt.plot(res["years"], res["uncertainty_adjusted_diff"],label="$\lambda_3={:.4f}$".format(gamma_3_list[id_damage]),linewidth=5.0)
#                 else:
#                     plt.plot(res["years"], res["uncertainty_adjusted_diff"],label="$\lambda_3={:.4f}$".format(gamma_3_list[id_damage]),linewidth=5.0)
...
# plt.savefig(Plot_Dir+"/UADPost_"+labellist[id_xiag]+Filename+"_rho={}_delta={}_phi0={}".format(rho,delta,phi_0)+".png")
# plt.close()
...
#                     plt.plot(res["years"], res["uncertainty_adjusted_diff2"],label="$\lambda_3={:.4f}$".format(gamma_3_list[id_damage]),linewidth=1.0)
#                 else:
#                     plt.plot(res["years"], res["uncertainty_adjusted_diff2"],label="$\lambda_3={:.4f}$".format(gamma_3_list[id_damage]),linewidth=1.0)
...
# plt.savefig(Plot_Dir+"/UAD2Post_"+labellist[id_xiag]+Filename+"_rho={}_delta={}_phi0={}".format(rho,delta,phi_0)+".png")
# plt.close()
...
#                     plt.plot(res["years"], res["v_post_techt"],label="$\lambda_3={:.4f}$".format(gamma_3_list[id_damage]),linewidth=5.0)
#                 else:
#                     plt.plot(res["years"],res["v_post_techt"],label="$\lambda_3={:.4f}$".format(gamma_3_list[id_damage]),linewidth=5.0)
...
# plt.savefig(Plot_Dir+"/VgtPost_"+labellist[id_xiag]+Filename+"_rho={}_delta={}_phi0={}".format(rho,delta,phi_0)+".png")
# plt.close()
...
#                     plt.plot(res["years"], res["vt"],label="$\lambda_3={:.4f}$".format(gamma_3_list[id_damage]),linewidth=5.0)
#                 else:
#                     plt.plot(res["years"], res["vt"],label="$\lambda_3={:.4f}$".format(gamma_3_list[id_damage]),linewidth=5.0)
...
# plt.savefig(Plot_Dir+"/VtPost_"+labellist[id_xiag]+Filename+"_rho={}_delta={}_phi0={}".format(rho,delta,phi_0)+".png")
# plt.close()
...
#                     plt.plot(res["years"], (res["v_post_techt"]-res["vt"]),label="$\lambda_3={:.4f}$".format(gamma_3_list[id_damage]),linewidth=5.0)
#                 else:
#                     plt.plot(res["years"], (res["v_post_techt"]-res["vt"]),label="$\lambda_3={:.4f}$".format(gamma_3_list[id_damage]),linewidth=5.0)
...
# plt.savefig(Plot_Dir+"/Vg-VtPost_"+labellist[id_xiag]+Filename+"_rho={}_delta={}_phi0={}".format(rho,delta,phi_0)+".png")
# plt.close()
...
#                     plt.plot(res["years"], (res["gt_tech"]),label="$\lambda_3={:.4f}$".format(gamma_3_list[id_damage]),linewidth=5.0)
#                 else:
#                     plt.plot(res["years"], (res["gt_tech"]),label="$\lambda_3={:.4f}$".format(gamma_3_list[id_damage]),linewidth=5.0)
...
# plt.savefig(Plot_Dir+"/gtPost_"+labellist[id_xiag]+Filename+"_rho={}_delta={}_phi0={}".format(rho,delta,phi_0)+".png")
# plt.close()
...
#                     plt.plot(res["years"], ( sigma_y * res["e"] * res["ht"]),label="$\lambda_3={:.4f}$".format(gamma_3_list[id_damage])  )
#                 else:
#                     plt.plot(res["years"], ( sigma_y * res["e"] * res["ht"]),label="$\lambda_3={:.4f}$".format(gamma_3_list[id_damage])  )
...
#                     plt.plot(res["years"], -(sigma_k * res["hkt"]),label="$\lambda_3={:.4f}$".format(gamma_3_list[id_damage])  )
#                 else:
#                     plt.plot(res["years"], -(sigma_k * res["hkt"]),label="$\lambda_3={:.4f}$".format(gamma_3_list[id_damage])  )
...
#                     plt.plot(res["years"], -(sigma_g * res["hjt"]),label="$\lambda_3={:.4f}$".format(gamma_3_list[id_damage])  )
#                 else:
#                     plt.plot(res["years"], -(sigma_g * res["hjt"]),label="$\lambda_3={:.4f}$".format(gamma_3_list[id_damage])  )
...
#                     plt.plot(res["years"], (  res["ht"]),label="$\lambda_3={:.4f}$".format(gamma_3_list[id_damage])  )
#                 else:
#                     plt.plot(res["years"], (  res["ht"]),label="$\lambda_3={:.4f}$".format(gamma_3_list[id_damage])  )
...
#                     plt.plot(res["years"], -( res["hkt"]),label="$\lambda_3={:.4f}$".format(gamma_3_list[id_damage])  )
#                 else:
#                     plt.plot(res["years"], -( res["hkt"]),label="$\lambda_3={:.4f}$".format(gamma_3_list[id_damage])  )
...
#                     plt.plot(res["years"], -( res["hjt"]),label="$\lambda_3={:.4f}$".format(gamma_3_list[id_damage])  )
#                 else:
#                     plt.plot(res["years"], -( res["hjt"]),label="$\lambda_3={:.4f}$".format(gamma_3_list[id_damage])  )
...
#                     plt.plot(res["years"], (  res["RelativeEntropy_hk"]),label="$\lambda_3={:.4f}$".format(gamma_3_list[id_damage])  )
#                 else:
#                     plt.plot(res["years"], (  res["RelativeEntropy_hk"]),label="$\lambda_3={:.4f}$".format(gamma_3_list[id_damage])  )
...
#                     plt.plot(res["years"], (  res["RelativeEntropy_h"]),label="$\lambda_3={:.4f}$".format(gamma_3_list[id_damage])  )
#                 else:
#                     plt.plot(res["years"], (  res["RelativeEntropy_h"]),label="$\lambda_3={:.4f}$".format(gamma_3_list[id_damage])  )
...
#                     plt.plot(res["years"], (  res["RelativeEntropy_hj"]),label="$\lambda_3={:.4f}$".format(gamma_3_list[id_damage])  )
#                 else:
#                     plt.plot(res["years"], (  res["RelativeEntropy_hj"]),label="$\lambda_3={:.4f}$".format(gamma_3_list[id_damage])  )
...
#                     plt.plot(res["years"], (  res["RelativeEntropy_TechJump"]),label="$\lambda_3={:.4f}$".format(gamma_3_list[id_damage])  )
#                 else:
#                     plt.plot(res["years"], (  res["RelativeEntropy_TechJump"]),label="$\lambda_3={:.4f}$".format(gamma_3_list[id_damage])  )
...
#                     plt.plot(res["years"], (  res["RelativeEntropy_DamageJump"]),label="$\lambda_3={:.4f}$".format(gamma_3_list[id_damage])  )
#                 else:
#                     plt.plot(res["years"], (  res["RelativeEntropy_DamageJump"]),label="$\lambda_3={:.4f}$".format(gamma_3_list[id_damage])  )
...
#                         alpha=0.5, color="C0", ec="darkgray",label="$\lambda_3={:.4f}$".format(gamma_3_list[id_damage]), bins=NUM_DAMAGE)
#                 if vartheta_bar==0.1:
...
#                 plt.savefig(Plot_Dir+"/Gamma3_{},".format(plot_year_gamma)+labellist[id_xiag] + "_rho={}_delta={}_phi0={}.png".format(rho,delta,phi_0))
#                 plt.close()
...
#                         alpha=0.5, ec="darkgrey", color="C0",label="$\lambda_3={:.4f}$".format(gamma_3_list[id_damage])  )
#                 plt.legend(loc='upper left')
#                 # plt.title("Distorted Probability of Climate Models")
...
#                 plt.savefig(Plot_Dir+"/ClimateSensitivity_pmean_{},".format(plot_year_theta) +labellist[id_xiag]+"_rho={}_delta={}_phi0={}.png".format(rho,delta,phi_0))
#                 plt.close()
