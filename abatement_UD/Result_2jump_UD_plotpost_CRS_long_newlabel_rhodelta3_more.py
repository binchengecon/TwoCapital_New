...
def model_simulation_generate(xi_a,xi_k,xi_c,xi_j,xi_d,xi_g,psi_0,psi_1,varrho,rho,gamma_3_i):
    ...
    with open(Data_Dir + File_Dir+"model_tech1_post_damage_gamma_{:.4f}".format(gamma_3_i)+"_UD_simul_{}".format(IntPeriod)+ scheme + "_" +HJB_solution, "rb") as f:
        res = pickle.load(f)
...
for id_xiag in range(len(xiaarr)): 
    ...
    plt.savefig(Plot_Dir+"/RDPost_"+labellist[id_xiag]+Filename+"_rho={}_delta={}_phi0={}".format(rho,delta,phi_0)+".png")
    plt.close()
...
for id_xiag in range(len(xiaarr)): 
    ...
    plt.savefig(Plot_Dir+"/EPost_"+labellist[id_xiag]+Filename+"_rho={}_delta={}_phi0={}".format(rho,delta,phi_0)+".png")
    plt.close()
...
for id_xiag in range(len(xiaarr)): 
    ...
    plt.savefig(Plot_Dir+"/TAPost_"+labellist[id_xiag]+Filename+"_rho={}_delta={}_phi0={}".format(rho,delta,phi_0)+".png")
    plt.close()
