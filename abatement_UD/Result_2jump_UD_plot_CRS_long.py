        ...
        for id_psi1 in range(len(psi1arr)):
            for id_varrho in range(len(varrhoarr)):
                ...
                if xigarr[id_xiag]>10:
                    ...
                    plt.plot(res["years"][res["states"][:, 1]<1.5], ( sigma_y * res["e"] * res["ht"])[res["states"][:, 1]<1.5],label='Baseline'  )
                else:
                    plt.plot(res["years"][res["states"][:, 1]<1.5], ( sigma_y * res["e"] * res["ht"])[res["states"][:, 1]<1.5],label='$\\xi_c={:.3f}, \\xi_d={:.3f}, \\xi_g={:.3f}$' .format(xicarr[id_xiag], xidarr[id_xiag], xigarr[id_xiag])  )
        ...
        for id_psi1 in range(len(psi1arr)):
            for id_varrho in range(len(varrhoarr)):
                ...
                if xigarr[id_xiag]>10:
                    ...
                    plt.plot(res["years"][res["states"][:, 1]<1.5], -(sigma_k * res["hkt"])[res["states"][:, 1]<1.5],label='Baseline'  )
                else:
                    plt.plot(res["years"][res["states"][:, 1]<1.5], -(sigma_k * res["hkt"])[res["states"][:, 1]<1.5],label='$\\xi_c={:.3f}, \\xi_d={:.3f}, \\xi_g={:.3f}$' .format(xicarr[id_xiag], xidarr[id_xiag], xigarr[id_xiag])  )
...
plt.savefig(Plot_Dir+"/hk_{},xia={},xic={},xid={},xig={},psi0={},psi1={},varrho={}.pdf".format(IntPeriod, xiaarr,xicarr,xidarr,xigarr,psi0arr,psi1arr,varrhoarr))
plt.savefig(Plot_Dir+"/hk_{},xia={},xic={},xid={},xig={},psi0={},psi1={},varrho={}.png".format(IntPeriod, xiaarr,xicarr,xidarr,xigarr,psi0arr,psi1arr,varrhoarr))
plt.close()
        ...
        for id_psi1 in range(len(psi1arr)):
            for id_varrho in range(len(varrhoarr)):
                ...
                if xigarr[id_xiag]>10:
                    ...
                    plt.plot(res["years"][res["states"][:, 1]<1.5], -(sigma_g * res["hjt"])[res["states"][:, 1]<1.5],label='Baseline'  )
                else:
                    plt.plot(res["years"][res["states"][:, 1]<1.5], -(sigma_g * res["hjt"])[res["states"][:, 1]<1.5],label='$\\xi_c={:.3f}, \\xi_d={:.3f}, \\xi_g={:.3f}$' .format(xicarr[id_xiag], xidarr[id_xiag], xigarr[id_xiag])  )
...
plt.savefig(Plot_Dir+"/hj_{},xia={},xic={},xid={},xig={},psi0={},psi1={},varrho={}.pdf".format(IntPeriod, xiaarr,xicarr,xidarr,xigarr,psi0arr,psi1arr,varrhoarr))
plt.savefig(Plot_Dir+"/hj_{},xia={},xic={},xid={},xig={},psi0={},psi1={},varrho={}.png".format(IntPeriod, xiaarr,xicarr,xidarr,xigarr,psi0arr,psi1arr,varrhoarr))
plt.close()
        ...
        for id_psi1 in range(len(psi1arr)):
            for id_varrho in range(len(varrhoarr)):
                ...
                if xigarr[id_xiag]>10:
                    ...
                    plt.plot(res["years"][res["states"][:, 1]<1.5], (  res["ht"])[res["states"][:, 1]<1.5],label='$\\xi_c={:.3f}, \\xi_d={:.3f}, \\xi_g={:.3f}$' .format(xicarr[id_xiag], xidarr[id_xiag], xigarr[id_xiag])  )
...
plt.savefig(Plot_Dir+"/h2_{},xia={},xic={},xid={},xig={},psi0={},psi1={},varrho={}.pdf".format(IntPeriod, xiaarr,xicarr,xidarr,xigarr,psi0arr,psi1arr,varrhoarr))
plt.savefig(Plot_Dir+"/h2_{},xia={},xic={},xid={},xig={},psi0={},psi1={},varrho={}.png".format(IntPeriod, xiaarr,xicarr,xidarr,xigarr,psi0arr,psi1arr,varrhoarr))
plt.close()
        ...
        for id_psi1 in range(len(psi1arr)):
            for id_varrho in range(len(varrhoarr)):
                ...
                if xigarr[id_xiag]>10:
                    ...
                    plt.plot(res["years"][res["states"][:, 1]<1.5], -( res["hkt"])[res["states"][:, 1]<1.5],label='Baseline'  )
                else:
                    plt.plot(res["years"][res["states"][:, 1]<1.5], -( res["hkt"])[res["states"][:, 1]<1.5],label='$\\xi_c={:.3f}, \\xi_d={:.3f}, \\xi_g={:.3f}$' .format(xicarr[id_xiag], xidarr[id_xiag], xigarr[id_xiag])  )
...
plt.savefig(Plot_Dir+"/hk2_{},xia={},xic={},xid={},xig={},psi0={},psi1={},varrho={}.pdf".format(IntPeriod, xiaarr,xicarr,xidarr,xigarr,psi0arr,psi1arr,varrhoarr))
plt.savefig(Plot_Dir+"/hk2_{},xia={},xic={},xid={},xig={},psi0={},psi1={},varrho={}.png".format(IntPeriod, xiaarr,xicarr,xidarr,xigarr,psi0arr,psi1arr,varrhoarr))
plt.close()
        ...
        for id_psi1 in range(len(psi1arr)):
            for id_varrho in range(len(varrhoarr)):
                ...
                if xigarr[id_xiag]>10:
                    ...
                    plt.plot(res["years"][res["states"][:, 1]<1.5], -( res["hjt"])[res["states"][:, 1]<1.5],label='Baseline'  )
                else:
                    plt.plot(res["years"][res["states"][:, 1]<1.5], -( res["hjt"])[res["states"][:, 1]<1.5],label='$\\xi_c={:.3f}, \\xi_d={:.3f}, \\xi_g={:.3f}$' .format(xicarr[id_xiag], xidarr[id_xiag], xigarr[id_xiag])  )
...
plt.savefig(Plot_Dir+"/hj2_{},xia={},xic={},xid={},xig={},psi0={},psi1={},varrho={}.pdf".format(IntPeriod, xiaarr,xicarr,xidarr,xigarr,psi0arr,psi1arr,varrhoarr))
plt.savefig(Plot_Dir+"/hj2_{},xia={},xic={},xid={},xig={},psi0={},psi1={},varrho={}.png".format(IntPeriod, xiaarr,xicarr,xidarr,xigarr,psi0arr,psi1arr,varrhoarr))
plt.close()
