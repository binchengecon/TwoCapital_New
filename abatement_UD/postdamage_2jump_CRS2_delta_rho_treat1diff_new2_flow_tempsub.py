...
from src.PreSolver_CRS2_newflow import hjb_pre_tech
from src.PostSolver_new_rho1 import hjb_post_tech as hjb_post_tech_rho1
from src.PreSolver_CRS2_newflow_rho1 import hjb_pre_tech as hjb_pre_tech_rho1
import argparse
...
parser.add_argument("--psi_01", type=float, default=0.003)
parser.add_argument("--psi_02", type=float, default=0.003)
parser.add_argument("--psi0_sub", type=float, default=0.003)
...
parser.add_argument("--subname",type=str,default="ReplicateSuri")
...
Data_Dir_sub = Output_Dir+"abatement/data_2tech/"+args.subname+"/"

File_Name = "xi_a_{}_xi_k_{}_xi_c_{}_xi_j_{}_xi_d_{}_xi_g_{}_psi_01_{}_psi_02_{}_psi_1_{}_varrho_{}_rho_{}_delta_{}_" .format(xi_a, xi_k, xi_c, xi_j, xi_d, xi_g, psi_01, psi_02, psi_1, varrho, rho, delta)
File_Name_sub = "xi_a_{}_xi_k_{}_xi_c_{}_xi_j_{}_xi_d_{}_xi_g_{}_psi_0_{}_psi_1_{}_varrho_{}_rho_{}_delta_{}_" .format(xi_a, xi_k, xi_c, xi_j, xi_d, xi_g, psi0_sub, psi_1, varrho, rho, delta)
...
Guess = pickle.load(open(Data_Dir_sub + File_Name_sub + "model_tech2_post_damage_gamma_{:.4f}".format(gamma_3_i), "rb"))
...
if rho==1:
    ...
    model_tech2_post_damage = hjb_post_tech_rho1(
            state_grid=(K, Y, L), 
            model_args=(delta, alpha, theta, vartheta_bar, lambda_bar, mu_k, kappa, sigma_k, theta_ell, pi_c_o, pi_c, sigma_y, zeta, psi_01, psi_1, sigma_g, gamma_1, gamma_2, gamma_3_i, y_bar, xi_a, xi_k, xi_c, xi_j, xi_d, xi_g,rho, varrho),
            V_post_damage=None,
...
with open(Data_Dir_sub+ File_Name_sub + "model_tech1_post_damage_gamma_{:.4f}".format(gamma_3_i), "rb") as f:
    Guess = pickle.load(f)
# Guess = None
...
if rho==1:
    ...
    res = hjb_pre_tech_rho1(
            state_grid=(K, Y, L), 
            model_args=(delta, alpha, theta, vartheta_bar, lambda_bar, mu_k, kappa, sigma_k, theta_ell, pi_c_o, pi_c, sigma_y, zeta, psi_01, psi_02, psi_1, sigma_g, V_post_tech2, gamma_1, gamma_2, gamma_3_i, y_bar, xi_a, xi_k, xi_c, xi_j, xi_d, xi_g,rho, varrho),
            V_post_damage=None,
