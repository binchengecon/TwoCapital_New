...
Phi_m_II = model_tech2_post_damage["v0"]
Phi_m = model_tech1_post_damage["v0"]

F_m_II = np.zeros_like(Phi_m_II)
...
print("-------------------------------------------")
print("------------FK Post damage, Distorted----------")
print("-------------------------------------------")
...
print("-------------------------------------------")
print("------------FK Post damage, Undistorted----------")
print("-------------------------------------------")
