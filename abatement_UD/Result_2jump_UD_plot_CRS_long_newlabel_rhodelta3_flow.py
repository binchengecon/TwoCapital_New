...
def model_simulation_generate(xi_a,xi_k,xi_c,xi_j,xi_d,xi_g,psi_01,psi_02,psi_1,varrho,rho):
        ...
        for id_psi02 in range(len(psi02arr)):
            for id_psi1 in range(len(psi1arr)):
                for id_varrho in range(len(varrhoarr)):
                    ...
                    # plt.savefig("./abatement/pdf_2tech/"+args.dataname+"/ClimateSensitivity_25,xia={:.4f},xic={:.3f},xid={:.3f},xig={:.3f},psi0={:.3f},psi1={:.3f},BC.pdf".format(xiaarr[id_xiag],xikarr[id_xiag],xicarr[id_xiag],xijarr[id_xiag],xidarr[id_xiag],xigarr[id_xiag],psi01arr[id_psi01],psi02arr[id_psi02],psi1arr[id_psi1]))
                    # plt.savefig("./abatement/pdf_2tech/"+args.dataname+"/ClimateSensitivity_25,xia={:.4f},xic={:.3f},xid={:.3f},xig={:.3f},psi0={:.3f},psi1={:.3f},BC.png".format(xiaarr[id_xiag],xikarr[id_xiag],xicarr[id_xiag],xijarr[id_xiag],xidarr[id_xiag],xigarr[id_xiag],psi01arr[id_psi01],psi02arr[id_psi02],psi1arr[id_psi1]))
                    # plt.close()
