...
Guess = pickle.load(open(Data_Dir_sub + File_Name_sub + "model_tech2_pre_damage", "rb"))
...
Guess = pickle.load(open(Data_Dir_sub + File_Name_sub + "model_tech1_pre_damage", "rb"))
# Guess = None

if rho==1:
    model_args =(delta, alpha, theta, vartheta_bar, lambda_bar, mu_k, kappa, sigma_k, theta_ell, pi_c_o, pi_c, sigma_y, zeta, psi_01, psi_02, psi_1, sigma_g, v_tech2, gamma_1, gamma_2, gamma_3_list, y_bar, xi_a, xi_k, xi_c, xi_j, xi_d, xi_g, rho, varrho)
