...
def model_simulation_generate(xi_a,xi_k,xi_c,xi_j,xi_d,xi_g,rho,psi_0,psi_1,varrho):
    ...
    for SimEpisodeNum in range(SimEpisode):
        ...
        with open(Data_Dir + File_Dir+"model_tech1_pre_damage"+"_UD_simulstoc2_{}_path_{}".format(IntPeriod, SimEpochNum*SimEpisode + SimEpisodeNum)+ scheme + "_" +HJB_solution, "wb") as f:
            pickle.dump(res,f)
