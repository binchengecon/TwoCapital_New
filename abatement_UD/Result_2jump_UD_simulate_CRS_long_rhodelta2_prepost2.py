...
def simulate_pre(
    ...
    for tm in range(pers):
        if tm == 0:
            ...
            if hist[tm,1]>=1.5 and hist[tm-1,1]<1.5:
                ...
                hist_temp = np.array((hist[tm,0],2,hist[tm,2]))
                
                RD_15_percentage_low = (x_post_low_func(hist_temp) - x_hist[tm])/x_hist[tm]*100
                RD_15_percentage_high = (x_post_high_func(hist_temp) - x_hist[tm])/x_hist[tm]*100
                E_15_percentage_low = (e_post_low_func(hist_temp) - e_hist[tm])/e_hist[tm]*100
                E_15_percentage_high = (e_post_high_func(hist_temp) - e_hist[tm])/e_hist[tm]*100

            if hist[tm,1]>=1.75 and hist[tm-1,1]<1.75:
                
                hist_temp = np.array((hist[tm,0],2,hist[tm,2]))

                RD_175_percentage_low = (x_post_low_func(hist_temp) - x_hist[tm])/x_hist[tm]*100
                RD_175_percentage_high = (x_post_high_func(hist_temp) - x_hist[tm])/x_hist[tm]*100
                E_175_percentage_low = (e_post_low_func(hist_temp) - e_hist[tm])/e_hist[tm]*100
                E_175_percentage_high = (e_post_high_func(hist_temp) - e_hist[tm])/e_hist[tm]*100
            ...
            if hist[tm,1]>=2 and hist[tm-1,1]<2:
                ...
                RD_2_percentage_low = (x_post_low_func(hist_temp) - x_hist[tm])/x_hist[tm]*100
                RD_2_percentage_high = (x_post_high_func(hist_temp) - x_hist[tm])/x_hist[tm]*100
                E_2_percentage_low = (e_post_low_func(hist_temp) - e_hist[tm])/e_hist[tm]*100
                E_2_percentage_high = (e_post_high_func(hist_temp) - e_hist[tm])/e_hist[tm]*100
    ...
    print("({:.2f}\\%, {:.2f}\\%) & ({:.2f}\\%, {:.2f}\\%) & ({:.2f}\\%, {:.2f}\\%) \\cr ".format(RD_15_percentage_low[0], RD_15_percentage_high[0], RD_175_percentage_low[0], RD_175_percentage_high[0], RD_2_percentage_low[0], RD_2_percentage_high[0]))    
    print("({:.2f}\\%, {:.2f}\\%) & ({:.2f}\\%, {:.2f}\\%) & ({:.2f}\\%, {:.2f}\\%) \\cr".format(E_15_percentage_low[0], E_15_percentage_high[0], E_175_percentage_low[0], E_175_percentage_high[0], E_2_percentage_low[0], E_2_percentage_high[0]))    
    ...
    plt.plot(gamma_3_list,xhist_chart1_15,label="Low Capital, Low R&D Stock")
    plt.xlabel("$\lambda_3$")
    plt.legend()
    plt.ylim(0,10)
    plt.savefig(Plot_Dir+"/RD_lambda3_,"+label+"chart_k15_j15"+"_rho={}_delta={}_phi0={}.png".format(rho,delta,phi_0))
    plt.close()
    
    
    plt.plot(gamma_3_list,xhist_chart1_2,label="Low Capital, High R&D Stock")
    plt.xlabel("$\lambda_3$")
    plt.legend()
    plt.ylim(0,10)
    plt.savefig(Plot_Dir+"/RD_lambda3_,"+label+"chart_k15_j2"+"_rho={}_delta={}_phi0={}.png".format(rho,delta,phi_0))
    plt.close()
    
    plt.plot(gamma_3_list,xhist_chart3_15,label="High Capital, Low R&D Stock")
    plt.xlabel("$\lambda_3$")
    plt.legend()
    plt.ylim(0,10)
    plt.savefig(Plot_Dir+"/RD_lambda3_,"+label+"chart_k2_j15"+"_rho={}_delta={}_phi0={}.png".format(rho,delta,phi_0))
    plt.close()
    
    plt.plot(gamma_3_list,xhist_chart3_2,label="High Capital, High R&D Stock")
    plt.xlabel("$\lambda_3$")
    plt.legend()
    plt.ylim(0,10)
    plt.savefig(Plot_Dir+"/RD_lambda3_,"+label+"chart_k2_j2"+"_rho={}_delta={}_phi0={}.png".format(rho,delta,phi_0))
    plt.close()
    
    plt.plot(gamma_3_list,ehist_chart1_15,label="Low Capital, Low R&D Stock")
    plt.xlabel("$\lambda_3$")
    plt.legend()
    plt.ylim(10,20)
    plt.savefig(Plot_Dir+"/E_lambda3_,"+label+"chart_k15_j15"+"_rho={}_delta={}_phi0={}.png".format(rho,delta,phi_0))
    plt.close()
    
    
    plt.plot(gamma_3_list,ehist_chart1_2,label="Low Capital, High R&D Stock")
    plt.xlabel("$\lambda_3$")
    plt.legend()
    plt.ylim(10,20)
    plt.savefig(Plot_Dir+"/E_lambda3_,"+label+"chart_k15_j2"+"_rho={}_delta={}_phi0={}.png".format(rho,delta,phi_0))
    plt.close()
    
    plt.plot(gamma_3_list,ehist_chart3_15,label="High Capital, Low R&D Stock")
    plt.xlabel("$\lambda_3$")
    plt.legend()
    plt.ylim(10,20)
    plt.savefig(Plot_Dir+"/E_lambda3_,"+label+"chart_k2_j15"+"_rho={}_delta={}_phi0={}.png".format(rho,delta,phi_0))
    plt.close()
    
    plt.plot(gamma_3_list,ehist_chart3_2,label="High Capital, High R&D Stock")
    plt.xlabel("$\lambda_3$")
    plt.legend()
    plt.ylim(10,20)
    plt.savefig(Plot_Dir+"/E_lambda3_,"+label+"chart_k2_j2"+"_rho={}_delta={}_phi0={}.png".format(rho,delta,phi_0))
    plt.close()
    ...
    plt.savefig(Plot_Dir+"/RD_hist2_,"+label+"chart1_15"+"_rho={}_delta={}_phi0={}.png".format(rho,delta,phi_0))
    plt.close()
    ...
    plt.legend(loc='upper left')
    plt.ylim(0,1)
    plt.savefig(Plot_Dir+"/RD_hist2_,"+label+"chart1_mid"+"_rho={}_delta={}_phi0={}.png".format(rho,delta,phi_0))
    plt.close()
    ...
    plt.legend(loc='upper left')
    plt.ylim(0,1)
    plt.savefig(Plot_Dir+"/RD_hist2_,"+label+"chart1_2"+"_rho={}_delta={}_phi0={}.png".format(rho,delta,phi_0))
    plt.close()
    ...
    plt.legend(loc='upper left')
    plt.ylim(0,1)
    plt.savefig(Plot_Dir+"/RD_hist2_,"+label+"chart2_15"+"_rho={}_delta={}_phi0={}.png".format(rho,delta,phi_0))
    plt.close()
    ...
    plt.legend(loc='upper left')
    plt.ylim(0,1)
    plt.savefig(Plot_Dir+"/RD_hist2_,"+label+"chart2_mid"+"_rho={}_delta={}_phi0={}.png".format(rho,delta,phi_0))
    plt.close()
    ...
    plt.xlabel('R&D Investment as Percentage of GDP',fontsize=20)
    plt.ylim(0,1)
    plt.savefig(Plot_Dir+"/RD_hist2_,"+label+"chart2_2"+"_rho={}_delta={}_phi0={}.png".format(rho,delta,phi_0))
    plt.close()
    ...
    plt.legend(loc='upper left')
    plt.ylim(0,1)
    plt.savefig(Plot_Dir+"/RD_hist2_,"+label+"chart3_15"+"_rho={}_delta={}_phi0={}.png".format(rho,delta,phi_0))
    plt.close()
    ...
    plt.legend(loc='upper left')
    plt.ylim(0,1)
    plt.savefig(Plot_Dir+"/RD_hist2_,"+label+"chart3_mid"+"_rho={}_delta={}_phi0={}.png".format(rho,delta,phi_0))
    plt.close()
    ...
    plt.legend(loc='upper left')
    plt.ylim(0,1)
    plt.savefig(Plot_Dir+"/RD_hist2_,"+label+"chart3_2"+"_rho={}_delta={}_phi0={}.png".format(rho,delta,phi_0))
    plt.close()
    ...
    plt.xlabel('R&D Investment as Percentage of GDP',fontsize=20)
    plt.ylim(0,1)
    plt.savefig(Plot_Dir+"/RD_hist2_,"+label+"chart4_15"+"_rho={}_delta={}_phi0={}.png".format(rho,delta,phi_0))
    plt.close()
    ...
    plt.legend(loc='upper left')
    plt.ylim(0,1)
    plt.savefig(Plot_Dir+"/RD_hist2_,"+label+"chart4_mid"+"_rho={}_delta={}_phi0={}.png".format(rho,delta,phi_0))
    plt.close()
    ...
    plt.legend(loc='upper left')
    plt.ylim(0,1)
    plt.savefig(Plot_Dir+"/RD_hist2_,"+label+"chart4_2"+"_rho={}_delta={}_phi0={}.png".format(rho,delta,phi_0))
    plt.close()
    ...
    plt.legend(loc='upper left')
    plt.ylim(0,2)
    plt.savefig(Plot_Dir+"/E_hist2_,"+label+"chart1_15"+"_rho={}_delta={}_phi0={}.png".format(rho,delta,phi_0))
    plt.close()
    ...
    plt.legend(loc='upper left')
    plt.ylim(0,2)
    plt.savefig(Plot_Dir+"/E_hist2_,"+label+"chart1_mid"+"_rho={}_delta={}_phi0={}.png".format(rho,delta,phi_0))
    plt.close()
    ...
    plt.legend(loc='upper left')
    plt.ylim(0,2)
    plt.savefig(Plot_Dir+"/E_hist2_,"+label+"chart1_2"+"_rho={}_delta={}_phi0={}.png".format(rho,delta,phi_0))
    plt.close()
    ...
    plt.legend(loc='upper left')
    plt.ylim(0,2)
    plt.savefig(Plot_Dir+"/E_hist2_,"+label+"chart2_15"+"_rho={}_delta={}_phi0={}.png".format(rho,delta,phi_0))
    plt.close()
    ...
    plt.legend(loc='upper left')
    plt.ylim(0,2)
    plt.savefig(Plot_Dir+"/E_hist2_,"+label+"chart2_mid"+"_rho={}_delta={}_phi0={}.png".format(rho,delta,phi_0))
    plt.close()
    ...
    plt.legend(loc='upper left')
    plt.ylim(0,2)
    plt.savefig(Plot_Dir+"/E_hist2_,"+label+"chart2_2"+"_rho={}_delta={}_phi0={}.png".format(rho,delta,phi_0))
    plt.close()
    ...
    plt.legend(loc='upper left')
    plt.ylim(0,2)
    plt.savefig(Plot_Dir+"/E_hist2_,"+label+"chart3_15"+"_rho={}_delta={}_phi0={}.png".format(rho,delta,phi_0))
    plt.close()
    ...
    plt.legend(loc='upper left')
    plt.ylim(0,2)
    plt.savefig(Plot_Dir+"/E_hist2_,"+label+"chart3_mid"+"_rho={}_delta={}_phi0={}.png".format(rho,delta,phi_0))
    plt.close()
    ...
    plt.legend(loc='upper left')
    plt.ylim(0,2)
    plt.savefig(Plot_Dir+"/E_hist2_,"+label+"chart3_2"+"_rho={}_delta={}_phi0={}.png".format(rho,delta,phi_0))
    plt.close()
    ...
    plt.legend(loc='upper left')
    plt.ylim(0,2)
    plt.savefig(Plot_Dir+"/E_hist2_,"+label+"chart4_15"+"_rho={}_delta={}_phi0={}.png".format(rho,delta,phi_0))
    plt.close()
    ...
    plt.legend(loc='upper left')
    plt.ylim(0,2)
    plt.savefig(Plot_Dir+"/E_hist2_,"+label+"chart4_mid"+"_rho={}_delta={}_phi0={}.png".format(rho,delta,phi_0))
    plt.close()
    ...
    plt.legend(loc='upper left')
    plt.ylim(0,2)
    plt.savefig(Plot_Dir+"/E_hist2_,"+label+"chart4_2"+"_rho={}_delta={}_phi0={}.png".format(rho,delta,phi_0))
    plt.close()
    ...
    res = dict(
        ...
        xhist_k15_j15 = xhist_chart1_15,
        xhist_k15_j2 = xhist_chart1_2,
        xhist_k2_j15 = xhist_chart3_15,
        xhist_k2_j2 = xhist_chart3_2,
        ehist_k15_j15 = ehist_chart1_15,
        ehist_k15_j2 = ehist_chart1_2,
        ehist_k2_j15 = ehist_chart3_15,
        ehist_k2_j2 = ehist_chart3_2,
